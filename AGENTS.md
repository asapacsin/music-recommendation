...
**[`docs/THESIS_QUESTIONS.md`](docs/THESIS_QUESTIONS.md)** — what each question tests, run IDs, report paths, status (A/B/C done; **D pending run**). Do not conflate B (Grok vs LLM captions) with D (tag vs tag→LLM training text).
