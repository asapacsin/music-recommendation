...
model.load_ckpt("model/music_audioset_epoch_15_esc_90.14.pt") # download the default pretrained checkpoint.

# Directly get audio embeddings from audio files
audio_file = [
    'data\input\Echo of Destiny.mp3',
    'data\input\Genesis.mp3'
]
...
audio_data, _ = librosa.load('data\input\Rebirth.mp3', sr=48000) # sample rate should be 48000
